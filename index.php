...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-7">
        ...
        <strong>Registrado!</strong> Datos capturados.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <?php
            }
      ...
      <?php
        ...
        ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong> Intentar otra vez.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <?php
            }
        ...
        ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Cambiado!</strong> Datos actualizados.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <?php
            }
        ...
        <strong>Eliminado!</strong> Datos borrados.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <?php
            }
          ...
          <table class="table align-middle">
            ...
            ?>
              ...
              <tr>
                ...
                <td><a class="text-success" href="editar.php?codigo=<?php echo $dato->codigo; ?>"><i class="bi bi-pencil-fill"></i></a></td>
                <td><a onclick="return confirm('Esta seguro de eliminar')" class="text-danger" href="eliminar.php?codigo=<?php echo $dato->codigo; ?>"><i class="bi bi-trash-fill"></i></a></td>               
              </tr>
